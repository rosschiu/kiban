...
// newTestPool connects to the live Postgres as kiban_timesheet (the runtime role — migrations must
// already be applied via `make migrate-timesheet`).
func newTestPool(t *testing.T) *pgxpool.Pool {
	return livestack.Pool(t, "kiban_timesheet", testEnv(t, "KIBAN_TIMESHEET_DB_PASSWORD"))
}
